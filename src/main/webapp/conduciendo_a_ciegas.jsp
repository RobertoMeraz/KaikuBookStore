    ...
    <body>
        ...
        <main>
            ...
            <div class="content">
                ...
                <div class="texto_justificado"><p>En estos veintidós relatos, Bradbury nos transporta una vez más a estos lugares increíbles, los destinos del corazón, revelados como no los hemos visto nunca antes, ni en la luz brillante del día ni en la oscuridad de la noche. Inolvidables excursiones a lo fantástico, viajes gloriosos a través del tiempo y la memoria, intercalados con extraños e inesperados desvíos a lo incómodo y desconcertante, donde las sorpresas esperan detrás de cada curva y más allá de cada señal del camino.

                        Sobre el diseño de portada:

                        Al ser una antología de relatos variados, se ha usado una imagen que hace referencia al título y que también es uno de las historias. Se ha trabajado la imagen de un coche retro americano y una carretera imposible. Es un concepto de corte fantástico que podría ilustrar el trasfondo del cuento del vendedor de coches ambulante, atormentado por la deformidad su cara.</p></div>
